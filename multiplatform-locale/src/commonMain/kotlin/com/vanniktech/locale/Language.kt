...
enum class Language(
  ...
  AMHARIC(
    code = "am",
    officialCountries = listOf(Country.ETHIOPIA),
  ...
  BELARUSIAN(
    code = "be",
    officialCountries = listOf(Country.BELARUS),
    otherCountries = listOf(Country.RUSSIA, Country.LITHUANIA, Country.LATVIA, Country.POLAND, Country.UKRAINE),
  ),
  BOKMAL(
    code = "nb",
  ...
  MACEDONIAN(
    code = "mk",
    officialCountries = listOf(Country.NORTH_MACEDONIA),
    otherCountries = listOf(Country.ALBANIA, Country.BOSNIA_AND_HERZEGOVINA, Country.ROMANIA, Country.SERBIA),
  ),
  MALAYALAM(
    code = "ml",
    officialCountries = listOf(Country.INDIA),
  ...
  URDU(
    code = "ur",
    officialCountries = listOf(Country.PAKISTAN),
    otherCountries = listOf(),
  ),
  UZBEK(
    code = "uz",
